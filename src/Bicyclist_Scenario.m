function [allData, scenario, sensors] = Bicyclist_Scenario()
%Bicyclist_Scenario - Returns sensor detections
%    allData = Bicyclist_Scenario returns sensor detections in a structure
%    with time for an internally defined scenario and sensor suite.
%
%    [allData, scenario, sensors] = Bicyclist_Scenario optionally returns
%    the drivingScenario and detection generator objects.

% Generated by MATLAB(R) 9.6 and Automated Driving Toolbox 2.0.
% Generated on: 28-Mar-2021 02:23:28
...
roadCenters = [150 0 0;
    75 0 0;
    0 0 0];marking = [laneMarking('Unmarked')
    laneMarking('Dashed')
    laneMarking('Dashed')];
